...
HAVE_DNS_SD_H = 1
LIBDIR = '/usr/lib/node:/usr/local/lib/node'
LIBPATH_NODE = '/usr/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_MDNS_DNS_SD_BACKEND = 1
NODE_PATH = '/usr/lib/node:/usr/local/lib/node'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr'
...
STATICLIB_MARKER = ''
STATICLIB_ST = '-l%s'
cfg_files = ['node_mdns_config.h']
defines = {'NODE_MDNS_DNS_SD_BACKEND': 1, 'HAVE_DNS_SD_H': 1, 'HAVE_DNSSERVICEGETADDRINFO': 1}
